    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('usuarios.store.direct') }}" method="POST" autocomplete="off">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('cpf') is-invalid @enderror" 
                                       id="cpf" name="cpf" value="{{ old('cpf') }}" inputmode="numeric" autocomplete="off" required>
                                @error('cpf')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="email" class="form-control @error('email') is-invalid @enderror" 
                                       id="email" name="email" value="{{ old('email','') }}" autocomplete="new-email" autocapitalize="none" spellcheck="false" placeholder="nome@exemplo.com" required>
                                @error('email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('telefone') is-invalid @enderror" 
                                       id="telefone" name="telefone" value="{{ old('telefone') }}" inputmode="numeric" autocomplete="tel">
                                @error('telefone')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('celular') is-invalid @enderror" 
                                       id="celular" name="celular" value="{{ old('celular') }}" inputmode="numeric" autocomplete="tel">
                                @error('celular')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-6 mb-3" id="campo_crm">
                                ...
                                <input type="text" class="form-control @error('crm') is-invalid @enderror" 
                                       id="crm" name="crm" value="{{ old('crm') }}" placeholder="Informe o CRM">
                                @error('crm')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-6 mb-3" id="campo_coren">
                                ...
                                <input type="text" class="form-control @error('coren') is-invalid @enderror" 
                                       id="coren" name="coren" value="{{ old('coren') }}" placeholder="Informe o COREN">
                                @error('coren')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <select class="form-select @error('tipo_usuario') is-invalid @enderror" id="tipo_usuario" name="tipo_usuario" required>
                                    ...
                                    <option value="ENFERMEIRO" {{ old('tipo_usuario') == 'ENFERMEIRO' ? 'selected' : '' }}>Enfermeiro</option>
                                ...
                                <div class="alert alert-info d-flex align-items-start" role="alert">
                                    ...
                                    <div>
                                        ...
                                        <div class="form-check mt-2">
                                            <input class="form-check-input" type="checkbox" id="permite_gerenciar_pacientes" name="permite_gerenciar_pacientes" value="1" {{ old('permite_gerenciar_pacientes') ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check mt-2">
                                            <input class="form-check-input" type="checkbox" id="permite_liberar_observacao" name="permite_liberar_observacao" value="1" {{ old('permite_liberar_observacao') ? 'checked' : '' }}>
                                            <label class="form-check-label" for="permite_liberar_observacao">
                                                Permitir liberar pacientes em observação
                                            </label>
                                        </div>
                                        <div class="form-check mt-2">
                                            <input class="form-check-input" type="checkbox" id="permite_extrair_relatorios" name="permite_extrair_relatorios" value="1" {{ old('permite_extrair_relatorios') ? 'checked' : '' }}>
                            ...
                            <div class="col-12">
                                <div class="alert alert-info d-flex align-items-start" role="alert">
                                    ...
                                    <div>
                                        ...
                                        <div class="form-check mt-2">
                                            <input class="form-check-input" type="checkbox" id="permite_extrair_relatorios_medico" name="permite_extrair_relatorios" value="1" {{ old('permite_extrair_relatorios') ? 'checked' : '' }}>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    selectTipo.addEventListener('change', togglePerm);
    togglePerm(); // inicial

    // Garante e-mail vazio ao abrir a tela (evita autofill)
    if (emailInput) {
        emailInput.value = '';
        // Se o navegador tentar autofill depois, limpa na primeira interação
        emailInput.addEventListener('focus', function once() {
            if (emailInput.value !== '') emailInput.value = '';
            emailInput.removeEventListener('focus', once);
        });
    }
